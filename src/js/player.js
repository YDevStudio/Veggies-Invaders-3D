...
export default class Player {
  ...
  static async createSpaceship() {
    ...
    potato = await GameConfig.chargerModeleGLTF('/medias/models/potato.gltf');
  ...
  static async createGlass() {
    ...
    for (let i = 0; i < 4; i++) {
      const stone = await GameConfig.chargerModeleGLTF('/medias/models/glass.gltf');
  ...
  static async createbulletPlayer() {
    const gltf = await GameConfig.chargerModeleGLTF('/medias/models/bullet.gltf');
